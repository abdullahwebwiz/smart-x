  ...
  return (
    ...
    >
      <a
        ...
        className='bg-gray-light text-body-color dark:bg-gray-dark mb-3 inline-flex h-9 w-9 items-center justify-center rounded-sm duration-300 hover:bg-primary hover:text-white dark:hover:bg-primary sm:ml-3'
      >
        <svg
          width='16'
          height='16'
      ...
      <a
        href='#0'
        aria-label='social-share'
        className='bg-gray-light text-body-color dark:bg-gray-dark mb-3 ml-3 inline-flex h-9 w-9 items-center justify-center rounded-sm duration-300 hover:bg-primary hover:text-white dark:hover:bg-primary'
      >
        <svg
          width='18'
          height='18'
