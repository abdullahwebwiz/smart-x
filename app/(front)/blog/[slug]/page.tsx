          ...
          <div className='-mx-4 flex flex-wrap justify-center'>
            <div className='w-full px-4 lg:w-8/12'>
              <div>
                ...
                <div className='border-body-color mb-10 flex flex-wrap items-center justify-between border-b border-opacity-10 pb-4 dark:border-white dark:border-opacity-10'>
                ...
                <div>
                  ...
                  <div className='my-5 relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9'>
                    <p className='text-body-color text-center text-base font-medium italic'>
                     Feel free to contact. We will be happy to help you out.
                    </p>
